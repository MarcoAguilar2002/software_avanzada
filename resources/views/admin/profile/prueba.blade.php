            ...
            <div class="col-md-3">
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <p class="text-muted text-center">Especialidad</p>
                    ...
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            <li class="nav-item"><a class="nav-link active" href="#activity"
                                    data-toggle="tab">Información Básica</a></li>
                            <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab">Estudios</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
