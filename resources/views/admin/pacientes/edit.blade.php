                ...
                <div class="card-body col-md-12">
                    <form action="{{ route('admin.pacientes.update',$paciente->id)}}" method="POST">
                            ...
                            <div class="col-md-3">
                                <div class="input-group mb-3">
                                    <input type="date" name="fecha_nacimiento" class="form-control"
                                        placeholder="Fecha nacimiento" value="{{ $paciente->fecha_nacimiento }}">
                            ...
                            <div class="col-md-4">
                                <div class="input-group mb-3">
                                    <input type="text" name="grupo_sanguineo" class="form-control"
                                        placeholder="grupo_sanguineo" value="{{ $paciente->grupo_sanguineo }}">
                            ...
                            <div class="col-md-4">
                                <div class="input-group mb-3">
                                    <input type="text" name="nro_seguro" class="form-control"
                                        placeholder="N° de seguro" value="{{ $paciente->nro_seguro }}">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="input-group mb-3">
                                    <textarea name="observaciones" class="form-control" placeholder="Observaciones">{{ $paciente->observaciones }}</textarea>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                            <span class="fas fa-user"></span>
                                        </div>
